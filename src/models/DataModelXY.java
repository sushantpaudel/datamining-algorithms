...
public class DataModelXY {
    ...
    public static DataModelXY[] generateDataSet() {
        DataModelXY[] dataSet = new DataModelXY[100];
        ...
        for (int i = 0; i < 100; i++) {
            DataModelXY model = new DataModelXY();
            model.setX(data[j]);
            j++;
            model.setY(data[j]);
            dataSet[i] = model;
    ...
    public static int calculateDistance(DataModelXY modelOne, DataModelXY modelTwo) {
